/*
 * Utility script for baking animations into textures,
 * to allow using animations when using GPU instancing, rendering particles or using Entities.
 * It is heavily inspired by the following article:
...
namespace LovelyBytes.AnimationTextures
{
    public class AnimationBaker : MonoBehaviour
    {
        ...
        [SerializeField, Tooltip("Bounding Box that encloses all provided animation clips. " +
                                 "Can be generated by the Method/ContextMenu 'CreateBoundingBox'." +
